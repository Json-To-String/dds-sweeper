...
Second, the number of channels should be configured with the `setchannels` command, which sets the number of dynamic channels, and leave the remaining channels static.
